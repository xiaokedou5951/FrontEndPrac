// NFTMarketPermit 合约 ABI：在 NFTMarket 基础上扩展 permitBuy / signer / domainSeparator / PERMIT_TYPEHASH
...
// NFTMarketPermit 合约 ABI
export const nftMarketPermitAbi = [
  {
    type: "function",
    name: "paymentToken",
    inputs: [],
...
// NFTMarketPermit 事件列表（watchEvent 需要单独传入 events，不能用完整 abi）
export const nftMarketPermitEvents = [
  {
    type: "event",
    name: "NFTListed",
    inputs: [

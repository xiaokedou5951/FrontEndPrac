...
```
NEXT_PUBLIC_TOKEN_ADDRESS        = MyERC20    合约地址
NEXT_PUBLIC_TOKENBANK_ADDRESS    = TokenBank  合约地址
NEXT_PUBLIC_NFT_MARKET_ADDRESS   = NFTMarket  合约地址
NEXT_PUBLIC_SIMPLE_NFT_ADDRESS   = SimpleNft  合约地址
```
...
+ NEXT_PUBLIC_TOKEN_ADDRESS=0x4C4a2f8c81640e47606d3fd77B353E87Ba015584

  # TokenBank 合约地址
- NEXT_PUBLIC_TOKENBANK_ADDRESS=0xc5a5C42992dECbae36851359345FE25997F5C42d
+ NEXT_PUBLIC_TOKENBANK_ADDRESS=0x21dF544947ba3E8b3c32561399E88B52Dc8b2823
```
